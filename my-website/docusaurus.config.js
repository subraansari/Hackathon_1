...
const config = {
  ...
  url: 'https://hackathon-1-omega-seven.vercel.app/', // Replace with your actual URL
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} ROS 2 Nervous System for Humanoid Robots. Built with Docusaurus.`,
      },
      prism: {
